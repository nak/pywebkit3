from ctypes import c_int, c_uint, c_ubyte, c_char_p,  CFUNCTYPE, Structure, c_ushort, POINTER, c_longlong
...
JSObjectCallAsFunctionCallback = CFUNCTYPE(c_longlong, OPAQUE_PTR, OPAQUE_PTR, OPAQUE_PTR, c_int, POINTER(OPAQUE_PTR),
                                           OPAQUE_PTR)
