...
GTK_JUNCTION_TOP    = c_int((GTK_JUNCTION_CORNER_TOPLEFT | GTK_JUNCTION_CORNER_TOPRIGHT))
GTK_JUNCTION_BOTTOM = c_int((GTK_JUNCTION_CORNER_BOTTOMLEFT | GTK_JUNCTION_CORNER_BOTTOMRIGHT))
GTK_JUNCTION_LEFT   = c_int((GTK_JUNCTION_CORNER_TOPLEFT | GTK_JUNCTION_CORNER_BOTTOMLEFT))
GTK_JUNCTION_RIGHT  = c_int((GTK_JUNCTION_CORNER_TOPRIGHT | GTK_JUNCTION_CORNER_BOTTOMRIGHT))
